  ...
  const SidebarContent = () => (
    <div className={cn(
      ...
      <div className="p-6 border-b border-border/50 flex items-center justify-between">
        <div className={cn("flex items-center gap-3 transition-opacity duration-300", isCollapsed && "opacity-0 w-0 overflow-hidden")}>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link key={item.href} href={item.href}>
              <div
                className={cn(
                  "flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 cursor-pointer group whitespace-nowrap",
                  isActive
              ...
              >
                <item.icon className={cn("w-5 h-5 shrink-0", isActive ? "text-primary-foreground" : "text-muted-foreground group-hover:text-primary")} />
      ...
      <div className="p-6 border-t border-border/50">
        <div className={cn("flex items-center gap-3 mb-4 px-2 transition-all", isCollapsed && "flex-col items-center px-0")}>
